...
class _MyAppState extends State<MyApp> {
  ...
  File? _imageFile;
  int _progress = 0;
  static const String ANDROID_DIRECTORY_DOWNLOADS =
      "/storage/emulated/0/Download/demo/";
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Image download app'),
        ),
        key: globalKey,
        body: Center(
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (Platform.isAndroid) {
                      if (checkPhotoIsDownloaded(filename)) {
                        final snackBar = SnackBar(content: Text('Photo downloaded'));
